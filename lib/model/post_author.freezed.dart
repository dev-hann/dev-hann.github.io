...
class _$PostAuthorImpl implements _PostAuthor {
  const _$PostAuthorImpl({required this.name, required this.dateTime});
  ...
  @override
  String toString() {
    return 'PostAuthor(name: $name, dateTime: $dateTime)';
  }
...
abstract class _PostAuthor implements PostAuthor {
  const factory _PostAuthor(
      ...
      required final DateTime dateTime}) = _$PostAuthorImpl;
